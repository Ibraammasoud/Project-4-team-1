...
yes_image_dir = r'with_cancer'  # Path to positive (tumor) images
no_image_dir = r'no_cancer'    # Path to negative (no tumor) images
...
def preprocess_image(img_path):
    ...
    nlm_filtered = denoise_nl_means(gray, h=1.15 * sigma_est, fast_mode=True, patch_size=5, patch_distance=3, multichannel=False)
